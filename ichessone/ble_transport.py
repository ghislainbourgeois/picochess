...
class Transport(object):
        ...
        for bledev in devs:
            ...
            for (adtype, desc, value) in bledev.getScanData():
                ...
                if desc == 'Complete Local Name':
                    if 'iChessOne' in value:
                        logger.info(
                            f'Autodetected iChessOne board at Bluetooth LE address: '
    ...
    def _device_open(self, address, device, que):
        ...
        try:
            ...
            self._agent_state(que, 'offline', emsg)
            return None, None
        self._agent_state(que, 'online', 'Connected to iChessOne board via BLE')
        return rx, tx
